        ...
        <Body className="mx-auto my-auto bg-white font-sans">
          <Container className="mx-auto my-10 w-[465px] p-5">
            ...
            <Text className="text-sm leading-6 text-black">
              I am Kgothatso, the maintainer of {BRAND_PLATFORM}. Thanks for
              creating a trial. Do you need any help with Data Rooms setup?
            </Text>
            <Text className="text-sm leading-6 text-black">Kgothatso Ntsane</Text>
          </Container>
        </Body>
      </Tailwind>
    </Html>
